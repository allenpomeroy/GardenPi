...
#
# Installation:
#  sudo cp irrigation-daemon.py /opt/garden/bin
#  sudo chown root: /opt/garden/bin/irrigation-daemon.py
#  sudo chmod 750   /opt/garden/bin/irrigation-daemon.py
# 
#  sudo cp irrigation-daemon.service /etc/systemd/system
#  sudo chown root: /etc/systemd/system/irrigation-daemon.service
#  sudo chmod 644   /etc/systemd/system/irrigation-daemon.service
#  sudo systemctl daemon-reload
#  sudo systemctl enable irrigation-daemon --now
#
# Command line options:
# irrigation-daemon.py -i {I2C addr hex} -l {0-5}
...
# History
# v2.7.1 2025/04/14
# - updated for bookworm debian .. required virtual python env
#   installed at /opt/garden/python3
# v2.7.0 2025/03/04
...
socket_file = "/tmp/irrigation-daemon.sock"
